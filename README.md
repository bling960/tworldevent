...
- Cloudinary도 마찬가지로 무료 플랜을 사용중이신 관계로 **용량이 초과**되면 더이상 이미지를 업로드하기 어려울 수 있습니다. 하지만 이미지 업로드는 사용자가 아닌 관리자 측에서만 진행되므로 Heroku만큼 이메일을 확인해주실 필요는 없습니다. 용량이 초과될 경우 [Cloudinary](https://cloudinary.com)에 들어가서 플랜을 업그레이드하시거나 기존에 업로드된 사진들을 삭제해주셔야 합니다.
